...
var commands = map[string][]byte{
	...
	"ChangeInput":    {0x02, 0x03, 0x00, 0x00, 0x02, 0x01, 0x00, 0x00},                   //Changes input
	"MuteOn":         {0x02, 0x12, 0x00, 0x00, 0x00, 0x14},                               //Mute on
	"MuteOff":        {0x02, 0x13, 0x00, 0x00, 0x00, 0x15},                               //Mute off
